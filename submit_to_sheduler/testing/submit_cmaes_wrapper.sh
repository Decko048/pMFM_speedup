...
function submit_job {
    ...
    cmd_script="source deactivate; source activate pMFM_speedup-torch1.8; python /home/ftian/storage/pMFM_speedup/src/testing/cmaes_wrapper.py ${split_name} ${idx_in_split}; source deactivate"

    job_path="/home/ftian/storage/pMFM_speedup/submit_to_sheduler/jobs/testing/cmaes_wrapper/${split_name}_${idx_in_split}/"
    mkdir -p ${job_path}
