...
mem='30G'
walltime='30:00:00'
name='naive_net_with_SC_use_coef'
script_location='/home/ftian/storage/pMFM_speedup/src/training/training_script/basic_models/naive_net_with_SC_use_coef.py'

function submit_job {
    cmd_script="source deactivate; source activate pMFM_speedup-torch1.8; python ${script_location}; source deactivate"

    job_path="/home/ftian/storage/pMFM_speedup/submit_to_sheduler/jobs/training/basic_models/${name}/"
    mkdir -p ${job_path}
